    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="{{asset('img/booklogo.png')}}" style="height: 50px; width: 120px;margin: 20,0,0,0px;"></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @endif
                    <a id="register_button" href="{{asset('cart')}}" class="btn btn-lg"> Swtich to cart </a>
                    ...
                    <li>
                        <a id="register_button" href="{{route('cart')}}" class="btn btn-lg"> Cart </a>
                    </li>
